    ...
    <select class="form-control" id="departementAffectation" name="departementAffectation" required>
        ...
        <option value="NTIC" <%= "NTIC".equals(enseignant.getDepartementAffectation()) ? "selected" : ""%>>NTIC</option>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dateRecrutement" name="dateRecrutement" value="<%=enseignant.getDateRecrutment()%>" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="etatActual" name="etatActual" required>
                        <option value="Actif" <%= enseignant.getEtatActual().equals("Actif") ? "selected" : "" %>>Actif</option>
                        <option value="Retraite" <%= enseignant.getEtatActual().equals("Retraite") ? "selected" : "" %>>Retraite</option>
                    </select>
                </div>
